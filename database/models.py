...
class User(Base):
    ...
    preferences = relationship("Tag", secondary=user_tag_association, back_populates="users")
...
class Place(Base):
    ...
    tags = relationship("Tag", secondary=place_tag_association, back_populates="places")
...
class Tag(Base):
    ...
    users = relationship("User", secondary=user_tag_association, back_populates="preferences")
